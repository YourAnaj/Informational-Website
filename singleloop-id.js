document.addEventListener('DOMContentLoaded', function () {
    ...
    const allQuestions = [
        { text: "What is the formula for calculating the induced EMF in a single coil according to Faraday's Law?", answer: "Induced EMF = -N × (dΦ/dt)" },
        { text: "What does the term 'magnetic flux' refer to in the context of electromagnetic induction in a coil?", answer: "Magnetic flux = B × A" },
        { text: "What is the effect of increasing the area of the coil on the induced EMF, assuming a changing magnetic field?", answer: "The induced EMF increases" },
        { text: "Which law explains why the induced EMF opposes the change in magnetic flux in a coil?", answer: "Lenz's Law" },
        { text: "If the magnetic field in a coil changes direction, what happens to the induced EMF?", answer: "The induced EMF reverses direction" },
        { text: "What happens to the induced EMF when the rate of change of the magnetic field through a coil increases?", answer: "The induced EMF increases" },
        { text: "What role does the number of turns in a coil play in determining the induced EMF?", answer: "More turns result in a higher induced EMF" },
        { text: "Which of the following would increase the induced EMF in a coil?", answer: "Increasing the magnetic field strength" },
        { text: "What happens to the induced current if the magnetic flux through the coil is constant?", answer: "No induced EMF or current is generated" },
        { text: "If the magnetic field is perpendicular to the coil's plane, what is the effect on the induced EMF?", answer: "Maximum induced EMF" }
    ];

    const extraWords = ["Increasing the coil’s resistance", "Decreasing the coil’s size"];
